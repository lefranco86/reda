...
export class Entreprise extends React.Component<IEntrepriseProps> {
  componentDidMount() {
    this.props.getEntities();
  }

  render() {
    const { entrepriseList, match } = this.props;
    return (
      <div>
        <h2 id="entreprise-heading">
          <Translate contentKey="redaApp.entreprise.home.title">Entreprises</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="redaApp.entreprise.home.createLabel">Create new Entreprise</Translate>
          </Link>
        </h2>
