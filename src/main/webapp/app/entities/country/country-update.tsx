...
export class CountryUpdate extends React.Component<ICountryUpdateProps, ICountryUpdateState> {
  ...
  render() {
    const { countryEntity, contactInformations, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="redaApp.country.home.createOrEditLabel">
              <Translate contentKey="redaApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
