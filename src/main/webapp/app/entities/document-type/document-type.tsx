    ...
    return (
      <div>
        <h2 id="document-type-heading">
          <Translate contentKey="redaApp.documentType.home.title">Document Types</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="redaApp.documentType.home.createLabel">Create new Document Type</Translate>
          </Link>
        </h2>
