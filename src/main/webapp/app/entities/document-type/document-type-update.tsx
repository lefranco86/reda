...
export class DocumentTypeUpdate extends React.Component<IDocumentTypeUpdateProps, IDocumentTypeUpdateState> {
  ...
  render() {
    const { documentTypeEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="redaApp.documentType.home.createOrEditLabel">
              <Translate contentKey="redaApp.documentType.home.createOrEditLabel">Create or edit a DocumentType</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
