  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="redaApp.documentType.delete.question">
          <Translate contentKey="redaApp.documentType.delete.question" interpolate={{ id: documentTypeEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-documentType" color="danger" onClick={this.confirmDelete}>
