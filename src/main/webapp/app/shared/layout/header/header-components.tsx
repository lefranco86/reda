...
export const Brand = props => (
  <NavbarBrand tag={Link} to="/" className="brand-logo">
    ...
    <span className="brand-title">
      <Translate contentKey="global.title">Reda</Translate>
    </span>
...
export const Style = props => (
  <NavItem>
    <NavLink tag={Link} to="/styleGuide" className="d-flex align-items-center">
      <FontAwesomeIcon icon="bible" />
      <span>
        <Translate contentKey="global.menu.styleGuide">Style Guide</Translate>
      </span>
    </NavLink>
  </NavItem>
);
