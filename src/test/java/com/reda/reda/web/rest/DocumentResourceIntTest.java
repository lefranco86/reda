...
public class DocumentResourceIntTest {
    ...
    private static final byte[] DEFAULT_TARGET = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_TARGET = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_TARGET_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_TARGET_CONTENT_TYPE = "image/png";
    ...
    public static Document createEntity(EntityManager em) {
        Document document = new Document()
            ...
            .targetContentType(DEFAULT_TARGET_CONTENT_TYPE)
            .name(DEFAULT_NAME);
        return document;
    }
    ...
    public void createDocument() throws Exception {
        ...
        assertThat(testDocument.getTarget()).isEqualTo(DEFAULT_TARGET);
        assertThat(testDocument.getTargetContentType()).isEqualTo(DEFAULT_TARGET_CONTENT_TYPE);
    ...
    public void getAllDocuments() throws Exception {
        ...
        restDocumentMockMvc.perform(get("/api/documents?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].targetContentType").value(hasItem(DEFAULT_TARGET_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].target").value(hasItem(Base64Utils.encodeToString(DEFAULT_TARGET))))
    ...
    public void getDocument() throws Exception {
        ...
        restDocumentMockMvc.perform(get("/api/documents/{id}", document.getId()))
            ...
            .andExpect(jsonPath("$.targetContentType").value(DEFAULT_TARGET_CONTENT_TYPE))
            .andExpect(jsonPath("$.target").value(Base64Utils.encodeToString(DEFAULT_TARGET)))
    ...
    public void updateDocument() throws Exception {
        ...
        updatedDocument
            ...
            .targetContentType(UPDATED_TARGET_CONTENT_TYPE)
            .name(UPDATED_NAME);
        ...
        Document testDocument = documentList.get(documentList.size() - 1);
        assertThat(testDocument.getTarget()).isEqualTo(UPDATED_TARGET);
        assertThat(testDocument.getTargetContentType()).isEqualTo(UPDATED_TARGET_CONTENT_TYPE);
