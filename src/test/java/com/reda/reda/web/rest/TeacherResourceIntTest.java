...
import com.reda.reda.repository.TeacherRepository;
...
public class TeacherResourceIntTest {
    ...
    private static final String DEFAULT_REGISTRATION_NUMBER = "AAAAAAA";
    private static final String UPDATED_REGISTRATION_NUMBER = "BBBBBBB";
    ...
    public static Teacher createEntity(EntityManager em) {
        ...
        em.flush();
        teacher.setContactInformation(contactInformation);
        return teacher;
    }
    ...
    public void createTeacher() throws Exception {
        ...
        assertThat(testTeacher.getRegistrationNumber()).isEqualTo(DEFAULT_REGISTRATION_NUMBER);
    ...
    public void checkRegistrationNumberIsRequired() throws Exception {
        ...
        // set the field null
        teacher.setRegistrationNumber(null);
    ...
    public void updateTeacher() throws Exception {
        ...
        Teacher testTeacher = teacherList.get(teacherList.size() - 1);
        assertThat(testTeacher.getRegistrationNumber()).isEqualTo(UPDATED_REGISTRATION_NUMBER);
